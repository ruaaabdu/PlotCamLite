...
from PyQt5.QtGui import QIcon, QImage, QPixmap, QClipboard
...
class Window(QMainWindow):
    ...
    def start_camera_thread(self):
        ...
        self.takePicture.connect(lambda: self.camera_thread1.take_picture(self.current_picture_path))
    ...
    def take_picture(self):
        ...
        """
        self.takePicture.emit(self.current_picture_path)
    ...
    def update_plot_number_label(self, new_plot_number):
        ...
        """
        self.plot_number_label.setText("Plot #: " + new_plot_number)
        self.current_plot_number = int(new_plot_number)
        self.current_picture_path = self.current_file_path + "\RGB\\"+ self.current_experiment_name + new_plot_number + ".bmp"
...
class NewFilePage(QDialog):
    ...
    def create_directories(self):
        ...
        try:
            ...
            success_msg.setDetailedText("Directory can be found at this file path: \n" + new_path)
...
def main():
    ...
    ex = Window()
    ex.show()
    #print(extra_functions.get_camera_serial())
    sys.exit(app.exec_())
