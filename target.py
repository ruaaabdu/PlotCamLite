...
# QtCode for components needed to customize QPainter
from PyQt5.QtCore import Qt, QPoint, QRect, QRectF, QPoint, QSize, QPointF, QTimer

# PyQt Widgets for the applicaton and layout
from PyQt5.QtWidgets import QMainWindow, QApplication, QWidget

# PyQt GUI for QPainter components
